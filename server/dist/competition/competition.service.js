...
let CompetitionService = class CompetitionService {
    ...
    createCompetition({ name, startDate, endDate, }) {
        return __awaiter(this, void 0, void 0, function* () {
            const competition = new competition_entity_1.Competition(name, startDate, endDate);
            const existedCompetition = yield this.competitionRepository.findBy(competition);
    ...
    getCompetition() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.competitionRepository.get();
        });
    }
};
CompetitionService = __decorate([
    (0, inversify_1.injectable)(),
    __param(0, (0, inversify_1.inject)(types_1.TYPES.CompetitionRepository)),
