...
let StageRepository = class StageRepository {
    ...
    create({ name, date, competitionId }) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.prismaService.client.stageModel.create({
                data: {
                    name,
                    date,
                    competitionId,
    ...
    findBy({ name }) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.prismaService.client.stageModel.findFirst({
                where: {
                    name,
                },
            });
